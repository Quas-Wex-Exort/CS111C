...
public class HomeworkM11Driver {
	...
	public static void main(String[] args) {
		...
		System.out.println("HashLocation of 497: " + voterTable.getHashLocation(497));
		...
		System.out.println("\n*****TESTING RETRIEVE FROM || getVoter()");
		System.out.println("Retrieved Delta Dem \t: " + voterTable.getVoter(v1.getId()));
		System.out.println("Retrieved Rita Rep \t: " + voterTable.getVoter(v2.getId()));
		System.out.println("Retrieved Ida Inde \t: " + voterTable.getVoter(v3.getId()));
		System.out.println("Retrieved Greta Green \t: " + voterTable.getVoter(v4.getId()));
		System.out.println("Retrieved Liz Libert \t: " + voterTable.getVoter(v5.getId()));
		System.out.println("Retrieved Ursula Undec \t: " + voterTable.getVoter(v6.getId()));
