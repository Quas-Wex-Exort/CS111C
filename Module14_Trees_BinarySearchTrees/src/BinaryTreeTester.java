...
public class BinaryTreeTester {
	...
	public static void main(String[] args) {
		...
		// root
		BinaryTree<Integer> numberTree = new BinaryTree<Integer>(4, tree1, tree1);
		BinaryTree<Integer> numberTree2 = new BinaryTree<Integer>(4, tree3, tree3);
		...
		*/
		...
		System.out.println("\nSUM OF numberTree: " + numberTree.getSum());


		//System.out.println("Number of occurrences of \'9\': " + count(4, numberTree));
		System.out.println("\nNumber of occurrences of \'1\' in numberTree: " + numberTree.count(1));
		System.out.println("\nNumber of occurrences of \'3\' in numberTree2: " + numberTree2.count(3));
		System.out.println("\nSUM OF numberTree2: " + numberTree2.getSum());
		System.out.println("PreOrder Traversal of numberTree2");
		numberTree2.recursivePreorderTraverse();
	}

	public static int count(int anEntry, BinaryTree<Integer> tree) {
		int count = 0;
		Iterator <Integer> iterator2 = tree.getInorderIterator();
		while (iterator2.hasNext()) {
			Integer nodeData = iterator2.next();
			if (nodeData.equals(anEntry)) {
				count++;
			}
		}
		return count;
