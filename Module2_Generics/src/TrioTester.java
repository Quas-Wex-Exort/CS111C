...
public class TrioTester {
	...
	public static void main(String[] args) {
		...
		System.out.println(numberTrio.toString());
		...
		System.out.println("Trio contains duplicates? false: " + numberTrio
		.hasDuplicates());
        ...
        numberTrio.setItem2(1);
        System.out.println("Trio contains how many 1s? 3: " + numberTrio.contains(1));
        numberTrio.setItem3(10);
        System.out.println("Trio contains how many 10s? 1: " + numberTrio.contains(10));
		...
		//System.out.println("Contents of wordTrio: " + wordTrio.getItemsList
		// ());
