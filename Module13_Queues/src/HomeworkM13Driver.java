...
public class HomeworkM13Driver {
	...
	public static void main(String[] args) {
		...
		System.out.println("calling display() method on lq1.");
		lq1.display();
	...
	public static void splice(QueueInterface firstQueue, QueueInterface secondQueue) {
		QueueInterface thirdQueue = new ArrayQueue();
		while (!secondQueue.isEmpty()) {
			firstQueue.enqueue(secondQueue.getFront());
			thirdQueue.enqueue(secondQueue.dequeue()); // if empty, exit while loop?
		}

		while (!thirdQueue.isEmpty()) { // fill up emptied secondQueue
			secondQueue.enqueue(thirdQueue.dequeue());
		}
	}
